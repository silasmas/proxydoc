(function($) {
    ...
    $('nav#dropdown').meanmenu({
        siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='index.html'><img src='assets/logo/logo1.png' alt='logo' height='60' width='60'  class='img-fluid'/></a></div>"
    });
